  ...
  return (
    <div>
      <div className="flex justify-center items-center min-h-screen bg-cover bg-center bg-gray-500">
        <div className="bg-white bg-opacity-80 py-10 px-5 sm:px-10 rounded-lg shadow-2xl tracking-wider max-w-96 mx-3 sm:max-w-[550px]">
          ...
          <div className="flex">
            <input
              type="text"
              className="border-2 border-white border-r-0 rounded-s-full py-2 px-5 w-full sm:w-96 focus:border-blue-500 focus:outline-none"
              value={password}
              readOnly
              ref={passwordRef}
            />
            <button
              className="py-2 px-5 font- rounded-e-full border-0 bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700"
